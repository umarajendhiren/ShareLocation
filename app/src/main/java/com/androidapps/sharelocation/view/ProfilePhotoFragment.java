        ...
        if (view.getId() == R.id.btn_continue) {
            ...
            if (!connected) {
               ...
               /* Navigation.findNavController(view)
                        .navigate(R.id.action_profilePhotoFragment2_to_NoNetworkFragment);*/
               ...
               /* Navigation.findNavController(view)
                        .navigate(R.id.action_profilePhotoFragment2_to_addPlacesFragment);
*/
            }
...
//            NavDirections action =ProfilePhotoFragmentDirections.actionProfilePhotoFragment2ToNoNetworkFragment();
