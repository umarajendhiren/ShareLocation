...
import com.androidapps.sharelocation.view.DriverLiveRoute;
import com.androidapps.sharelocation.view.DriverMapFragment;
import com.androidapps.sharelocation.view.SetBusStopNotificationActivity;
...
return repository.getDriverDetailsListLiveData();
    ...
    public MutableLiveData<Boolean> isDriverAvailable() {
         ...
         repository.isDriverCheckedIn(ParseUser.getCurrentUser().getObjectId());
...
//onPhoneCallClickInterface.onCall(userId);
    ...
    public void setDriverNotification(String driverId){
       ...
       // repository.getAllSavedBusStops(driverId);
        ...
        busStopDialog.putExtra("driverId",driverId);
...
*/
    ...
    public MutableLiveData<List<StringToJsonSerialization>> getLiveRouteBusStopDetails(){
        return repository.getliveRouteBusStopLive();
    }
    ...
    public void setSelectedBusStop(StringToJsonSerialization selectedBusStop) {
        repository.setSelectedBusStop(selectedBusStop);
    }

    public MutableLiveData<String> getDistanceLiveData() {

        return repository.getDistanceLiveInstance();
    }


    public MutableLiveData<String> getDurationLiveData() {

        return repository.getDurationLive();
    }


    public void setIsItRouteMap(boolean isItRute) {
         repository.isItRouteMap=isItRute;
    }

    public void setIsItRiderDriverMap() {
        repository.isItriderMapFragment=false;
    }
}
